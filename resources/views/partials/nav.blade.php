<nav class="bg-white shadow-xl pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
    ...
    <div class="flex flex-wrap items-center">
        ...
        <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-red-600 px-2 text-center">
            <span class="relative w-full bg-black">
                ...
                {{ (Session::get('verified') == false) ? '!! Email Belum Terverifikasi !!' : '' }}
            </span>
        </div>
